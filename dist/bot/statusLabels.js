...
export function applicationStatusLabel(status, rejectReason) {
    switch (status) {
        case "pending":
...
export function applicationStatusHtml(status, rejectReason) {
...
export function joinRequestStatusLabel(status) {
    switch (status) {
        case "pending":
...
export function inviteLinkStatusLabel(status) {
    switch (status) {
        case "active":
