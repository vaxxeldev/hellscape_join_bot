...
При обновлении с версии до миграции `008_reservation_invite_links.sql` существующая база обновится автоматически. Новые ссылки обычных и waitlist-броней хранятся в БД и создают Telegram join request. Старые прямые ссылки броней в прежней версии в БД не сохранялись: они продолжат действовать до собственного срока Telegram или до ручного отзыва администратором.
